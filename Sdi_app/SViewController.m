...
- (void)viewDidLoad
{
    ...
    [more_array addObject:@"seach bar display"];
    [more_array addObject:@"seach bar display advance"];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.row==0) {
        RootViewController *setting = [[RootViewController alloc] initWithNibName:@"RootViewController" bundle:[NSBundle mainBundle]];
