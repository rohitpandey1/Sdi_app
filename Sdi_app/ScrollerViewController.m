...
- (void)viewDidLoad
{
    ...
    [more_array addObject:@"Simple Scroller"];
    [more_array addObject:@"complex Scroller"];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    if (indexPath.row==0) {
        ScrollViewWithPagingViewController *setting = [[ScrollViewWithPagingViewController alloc] initWithNibName:@"ScrollViewWithPagingViewController" bundle:[NSBundle mainBundle]];
